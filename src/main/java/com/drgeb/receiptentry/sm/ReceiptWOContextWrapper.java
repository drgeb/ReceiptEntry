...
public class ReceiptWOContextWrapper implements ReceiptTransitions {
	...
	case CreateState:
	    receiptContext
		    .setState(ReceiptWOContext.ReceiptEntryMap.CreateState);
	    break;
	case ViewState:
	...
	case DeleteState:
	    receiptContext
		    .setState(ReceiptWOContext.ReceiptEntryMap.DeleteState);
	    break;
	case ExportState:
	    receiptContext
		    .setState(ReceiptWOContext.ReceiptEntryMap.ExportState);
	    break;
	default:
